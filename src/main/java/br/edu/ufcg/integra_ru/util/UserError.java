...
public class UserError {
    ...
    static final String VALOR_NAO_PODE_DEBITAR = "Credito nao pode ser debitado.";

    public static ResponseEntity<CustomErrorType> errorUsuarioJaExiste(Long matricula) {
        return new ResponseEntity<>(new CustomErrorType(String.format(USUARIO_JA_EXISTE, matricula)),
                HttpStatus.BAD_REQUEST);
    }

    public static ResponseEntity<CustomErrorType> errorUsuarioNaoCadastrado(String matricula) {
        return new ResponseEntity<>(new CustomErrorType(String.format(USUARIO_NAO_CADASTRADO, matricula)),
                HttpStatus.BAD_REQUEST);
    }

    public static ResponseEntity<CustomErrorType> errorNenhumUsuarioCadastrado() {
        return new ResponseEntity<>(new CustomErrorType(String.format(NENHUM_USUARIO_CADASTRADO)),
                HttpStatus.BAD_REQUEST);
    }
    ...
    public static ResponseEntity<CustomErrorType> errorValorNaoPodeSerDebitado() {
        return new ResponseEntity<>(new CustomErrorType(String.format(VALOR_NAO_PODE_DEBITAR)), HttpStatus.BAD_REQUEST);
    }
